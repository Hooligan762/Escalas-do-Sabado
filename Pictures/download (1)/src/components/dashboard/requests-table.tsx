    ...
    let filtered = requests.filter(
      (req) =>
        (req.requesterEmail.toLowerCase().includes(filter.toLowerCase()) ||
          req.details.toLowerCase().includes(filter.toLowerCase()) ||
          req.campus.toLowerCase().includes(filter.toLowerCase()) ||
          req.setor.toLowerCase().includes(filter.toLowerCase())) &&
