...
export default function AdminPasswordsPage() {
    ...
    const handleAddCampus = async (name: string) => {
        ...
        try {
            ...
            if (currentCampusList.some(c => c.name && name && c.name.toLowerCase() === name.toLowerCase())) {
            ...
            const newUsername = name ? name.toLowerCase().replace(/[^a-z0-9]/g, '') : '';
    ...
    const handleEditCampusAndUser = async (campusId: string | number, newCampusName: string, newUsername: string, newPassword?: string) => {
        try {
            ...
            const isCampusNameChanging = oldCampusName && newCampusName && oldCampusName.toLowerCase() !== newCampusName.toLowerCase();

            if (isCampusNameChanging && currentCampusList.some(c => c.id !== campusId && c.name && newCampusName && c.name.toLowerCase() === newCampusName.toLowerCase())) {
            ...
            <div className="min-h-screen bg-gray-50" suppressHydrationWarning>
                ...
                <main className="container mx-auto p-4 md:p-6 lg:p-8 mt-5">
                    <div className="flex items-center gap-4 mb-6">
                        <Button variant="outline" size="default" asChild className="flex items-center gap-2">
                            <Link href="/">
